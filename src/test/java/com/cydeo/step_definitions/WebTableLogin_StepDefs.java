...
public class WebTableLogin_StepDefs {
    ...
    public void userEntersUsernameAndUserEntersPassword(String username, String password) {
     /* webTableLoginPage.inputUsername.sendKeys(username);
      webTableLoginPage.inputUsername.sendKeys(password);
      webTableLoginPage.loginButton.click();*/
    ...
    public void userEntersBelowCredentials(Map<String,String> credebtials) {
       /*webTableLoginPage.inputUsername.sendKeys(credebtials.get("username"));
       webTableLoginPage.inputPassword.sendKeys(credebtials.get("password"));
       webTableLoginPage.loginButton.click();*/

        webTableLoginPage.login(credebtials.get("username"), credebtials.get("password") );
    }
}
