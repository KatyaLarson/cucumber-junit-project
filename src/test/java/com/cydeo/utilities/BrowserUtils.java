...
public class BrowserUtils {
    // Methods are static.Because we dont want to
    // to create an object to call those methods
    ...
    /**
     * This method will accept as a WebElement
    ...
    public static List<String> dropdownOptionsAsString(WebElement dropdownElement){
        ...
        List<WebElement> actualOptionsAsWebElemnt=select.getOptions();


        // list of actual month options as a string
        List<String> actualOptionsasString=new ArrayList<>();

        for (WebElement each: actualOptionsAsWebElemnt){
